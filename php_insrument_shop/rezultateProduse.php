	...
	if(isset($_POST["add-to-cart"])) {
		if(isset($_SESSION["cart"])) {
			...
			if(in_array($_POST["id-produs"], $productId_Array)) {
				...
				echo "<script>window.location = 'rezultateProduse.php'</script>";
			} else {
		...
		<div class="text-center">
			...
			<table class="table table-bordered table-striped text-center">
				...
				<tbody>	
					...
					<?php 
						if(isset($_POST['nume-produs'])) {
							$numeProdus = $_POST['nume-produs'];
							$_SESSION['nume-produs-search'] = $numeProdus;
						}
						$gestiuneProduse = new GestiuneProduse();
						$gc = new GestiuneCategorii();

						if(isset($numeProdus)) {
							$produse = $gestiuneProduse->getProduseDupaNume($numeProdus);
						} else {
							$produse = $gestiuneProduse->getProduseDupaNume($_SESSION['nume-produs-search']);
						}
					...
					<tr>
						...
						<td>
							<form id="cumparareProdus" action="rezultateProduse.php" method="post">
